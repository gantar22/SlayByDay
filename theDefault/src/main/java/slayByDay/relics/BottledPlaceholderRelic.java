...
import slayByDay.patches.relics.BottledPlaceholderField;
import slayByDay.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static slayByDay.DefaultMod.makeRelicOutlinePath;
import static slayByDay.DefaultMod.makeRelicPath;
