...
public class SlayByDay implements
    ...
    public static void setModID(String ID) {
        if (ID.equals("theDefault")) {
            throw new RuntimeException("Go to your constructor in your class with SpireInitializer and change your mod ID from \"slayByDay\"");
    ...
    public static void initialize() {
        ...
        SlayByDay defaultmod = new SlayByDay();
