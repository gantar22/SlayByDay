...
public class SpiritualCrystal extends CustomRelic {
    ...
    private static final Texture IMG = TextureLoader.getTexture(makeRelicPath("medium_placeholderRelic.png"));
    private static final Texture OUTLINE = TextureLoader.getTexture(makeRelicOutlinePath("medium_placeholderRelic.png"));
