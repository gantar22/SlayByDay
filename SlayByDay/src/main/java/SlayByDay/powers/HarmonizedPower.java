...
public class HarmonizedPower extends AbstractPower
implements OnSwitchPower {
    public AbstractCreature source;

    public static final String POWER_ID = SlayByDay.makeID("Harmonized");
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath("harmonizeIcon84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath("harmonizeIcon32.png"));

    public HarmonizedPower(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        name = NAME;
        ID = POWER_ID;
