...
public class RefillPower extends AbstractPower
implements PrePotionUseSubscriber, PostPotionUseSubscriber {
    ...
    public static boolean filled_this_potion = false;
