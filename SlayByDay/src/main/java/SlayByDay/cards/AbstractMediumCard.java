...
public abstract class AbstractMediumCard extends CustomCard {
    ...
    // simply use that in our cards, so long as we put "extends AbstractMediumCard" instead of "extends CustomCard" at the start.
    ...
    public AbstractMediumCard(final String id, final String name, final String img, final int cost, final String rawDescription,
